...
class NPUSparseAttnSharedKVOpBuilder(MindSpeedOpBuilder):
    ...
    def __init__(self):
        ...
        super(NPUSparseAttnSharedKVOpBuilder, self).__init__(self.OP_NAME)

    def sources(self):
        return ['ops/csrc/cann/npu_sparse_attn_shared_kv.cpp']
